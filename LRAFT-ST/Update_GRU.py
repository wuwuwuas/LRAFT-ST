...
class BasicMotionEncoder(nn.Module):
    def __init__(self, corr_levels, corr_radius):
        ...
        self.convc1 = nn.Conv2d(cor_planes, planes, 1, padding=0)
        self.convc2 = nn.Conv2d(planes, 96, 3, padding=1)
        
        planes = int(128 * 0.5)
        self.convf1 = nn.Conv2d(2, planes, 7, padding=3)
        self.convf2 = nn.Conv2d(planes, 32, 3, padding=1)
...
class BasicUpdateBlock(nn.Module):
    def __init__(self, corr_levels=4, corr_radius=4, hidden_dim=128, input_dim=128):
        ...
        self.gru = SepConvGRU(hidden_dim=128, input_dim=128+64)
        
        self.flow_head = FlowHead(hidden_dim, hidden_dim=int(256*0.5))
